...
/**
 * @author 27016005
 * Example with Drones, paddles and targets in arena
 */
public class DroneInterface extends Application {
	...
	private void showAbout() {
	    ...
	    alert.setContentText("27016005's JavaFX Demonstrator");			// give text
	...
	public void start(Stage primaryStage) throws Exception {
		...
		primaryStage.setTitle("27016005 Drone Simulation");
